...
class CreateTherapistScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<CreateTherapistScreen> createState() =>
      _CreateTherapistScreenState();
}
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
              content: Text('Terapeuta creado exitosamente'),
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildTextField(
                  'Nombre Completo', 'Ej. Dra. Ana López', _nombreCtrl,
                  icon: Icons.person, isRequired: true),
              const SizedBox(height: 16),
              _buildTextField('Correo Electrónico', 'ana@rimai.com', _emailCtrl,
                  icon: Icons.email,
                  isRequired: true,
                  keyboardType: TextInputType.emailAddress),
              const SizedBox(height: 16),
              _buildTextField(
                  'Contraseña Temporal', 'Mínimo 6 caracteres', _passwordCtrl,
                  icon: Icons.lock, isRequired: true, obscureText: true),
              ...
              const SizedBox(height: 16),
              _buildTextField('Especialidad',
                  'Ej. Terapia Ocupacional, Fonoaudiología', _especialidadCtrl,
                  icon: Icons.medical_services, isRequired: true),
              const SizedBox(height: 16),
              _buildTextField('Número de Colegiatura / Licencia',
                  'Ej. CBP-12345', _colegiaturaCtrl,
                  icon: Icons.badge, isRequired: true),
      ...
      children: [
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            hintText: hint,
            prefixIcon:
                Icon(icon, color: const Color(0xFFA43714).withOpacity(0.5)),
            filled: true,
            ...
            focusedBorder: OutlineInputBorder(
                borderRadius: BorderRadius.circular(16),
                borderSide:
                    const BorderSide(color: Color(0xFFA43714), width: 2)),
